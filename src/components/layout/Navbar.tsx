...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white border-b border-zinc-200 dark:border-zinc-800 transition-colors">
        ...
        <div className="flex items-center justify-between h-16 gap-4 sm:gap-6">
          ...
          <Link href="/" className="flex items-center gap-2.5 shrink-0 group">
            <img
              src="/logo.png"
              alt="Kretabazaar"
              className="h-9 w-auto object-contain rounded-lg group-hover:scale-105 transition-transform"
            />
          </Link>
